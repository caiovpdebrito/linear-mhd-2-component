...
def roots_trans_quartic(b0, T, k_vals, Sigma=1):
...
temperature = 1.0 # temperature in units of GeV
...
for idx, B in enumerate(B_values):
    roots_real, roots_imag = roots_trans_quartic(B, temperature, k_vals)
...
plt.tight_layout()
plt.savefig('trans-modes-quartic-T='+str(temperature)+'-GeV.pdf')
plt.show()